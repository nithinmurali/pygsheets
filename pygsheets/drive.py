...
class DriveAPIWrapper(object):
    ...
    def __init__(self, http, data_path, retries=3, logger=logging.getLogger(__name__), requestBuilder=None):
        ...
        try:
            ...
            self.service = discovery.build('drive', 'v3', http=http, discoveryServiceUrl=DISCOVERY_SERVICE_URL, requestBuilder=requestBuilder)
